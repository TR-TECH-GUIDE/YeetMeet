...
> Set ENVIRONMENT VARIABLES according to VARIABLES in [config.py](https://github.com/TR-TECH-GUIDE/YeetMeet/blob/master/config.py)


	
 1. Download and Install Google Chrome and Chromedriver.
 2. `git clone https://github.com/TR-TECH-GUIDE/YeetMeet`
 3. `cd YeetMeet`
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/TR-TECH-GUIDE/YeetMeet)
